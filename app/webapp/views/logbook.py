...
class LogEntryLocationForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'speed_knots', 'heading_degrees', 'depth_feet',
            'wind_speed_knots', 'wind_direction_degrees',
            'temperature_f', 'barometric_pressure', 'sea_state',
            'visibility_miles', 'timestamp'
        ]
        widgets = {
            ...
            'speed_knots': forms.NumberInput(attrs={
                'class': 'form-input',
                'step': '0.1',
                'min': '0'
            }),
            'heading_degrees': forms.NumberInput(attrs={
                'class': 'form-input',
                'min': '0',
                'max': '359'
            }),
            ...
            'wind_speed_knots': forms.NumberInput(attrs={
                'class': 'form-input',
                'step': '0.1',
                'min': '0'
            }),
            'wind_direction_degrees': forms.NumberInput(attrs={
                'class': 'form-input',
                'min': '0',
                'max': '359'
            }),
            ...
            'barometric_pressure': forms.NumberInput(attrs={
                'class': 'form-input',
                'step': '0.01',
                'min': '25',
                'max': '35'
            }),
            'sea_state': forms.TextInput(attrs={
                'class': 'form-input',
                'placeholder': 'e.g. Calm, Light chop, Moderate seas'
            }),
            'visibility_miles': forms.NumberInput(attrs={
                'class': 'form-input',
                'step': '0.1',
                'min': '0'
            }),
...
def log_entry_create(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and location_formset.is_valid() and attachment_formset.is_valid():
            ...
            # Save attachments with file uploads
            ...
            for i, attachment in enumerate(attachments):
                ...
                if file_field_name in request.FILES:
                    ...
                    # Auto-detect attachment type for images
...
def log_entry_edit(request, pk, entry_pk):
    ...
    if request.method == 'POST':
        ...
        location_formset = LocationFormSet(request.POST, instance=log_entry, prefix='locations')
        attachment_formset = AttachmentFormSet(request.POST, request.FILES, instance=log_entry, prefix='attachments')
        ...
        if form.is_valid() and location_formset.is_valid() and attachment_formset.is_valid():
            ...
            for i, attachment in enumerate(attachments):
                ...
                if file_field_name in request.FILES:
                    ...
                    # Delete old media if updating existing attachment
                    if attachment.media:
